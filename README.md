...
![](/competitions/121150/images/header)

Deep Past Challenge - Translate Akkadian to English
---------------------------------------------------

[Overview](/competitions/deep-past-initiative-machine-translation/overview)[Data](/competitions/deep-past-initiative-machine-translation/data)[Code](/competitions/deep-past-initiative-machine-translation/code)[Models](/competitions/deep-past-initiative-machine-translation/models)[Discussion](/competitions/deep-past-initiative-machine-translation/discussion)[Leaderboard](/competitions/deep-past-initiative-machine-translation/leaderboard)[Rules](/competitions/deep-past-initiative-machine-translation/rules)
...
Submissions are evaluated by the **Geometric Mean of the [BLEU](https://aclanthology.org/P02-1040.pdf) and the [chrF++](https://statmt.org/wmt17/pdf/WMT70.pdf) scores**, with each score's sufficient statistics being aggregated across the entire corpus (that is, each score is a _micro-average_).
...
*   **Broken text on the tablet**: as these are ancient texts, they include a number of breaks and lacunae. In order to standardize these breaks, we suggest using only two markers, one for a small break of a single sign <gap> and the other for more than one sign up to large breaks <big\_gap>.
...
@misc{deep-past-initiative-machine-translation,
    author = {Abdulla, F. and Agarwal, R. and Anderson, A. and Barjamovic, G. and Lassen, A. and Ryan Holbrook and María Cruz},
